...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        if (!!message.mention && message.mention[0] == '918592888446@s.whatsapp.net') {
